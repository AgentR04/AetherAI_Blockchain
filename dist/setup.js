...
async function main() {
    try {
        ...
        const privateKeyBytes = aptos_1.HexString.ensure(process.env.ADMIN_KEY || "").toUint8Array();
        const adminAccount = new aptos_1.AptosAccount(privateKeyBytes);
        ...
        await faucetClient.fundAccount(adminAccount.address(), 100000000);
        // Initialize module
        const payload = {
